...
export default function SignUpPage() {
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-slate-950 text-slate-100 overflow-hidden px-4 py-8">
      ...
      <div className="relative z-10 mb-6 flex flex-col items-center text-center">
        ...
        <p className="mt-1 text-xs text-slate-400 max-w-sm">
          Guwahati Bahini/Bharalu Basin • Hydrological Emergency Response Console
        </p>
        ...
        <div className="mt-3 flex items-center gap-2 text-[10px] font-mono text-cyan-400/80 bg-cyan-950/30 border border-cyan-500/20 px-2.5 py-0.5 rounded-full">
          ...
          <span>REQUEST NEW DISPATCH PRIVILEGES</span>
        </div>
      </div>
      ...
      <div className="relative z-10 mt-8 flex items-center gap-2 text-[11px] text-slate-500 font-mono">
        ...
        <span>GMDA / ASSAM SDMA TACTICAL PROTOCOL • ACCESS RESTRICTED</span>
      </div>
    </div>
  );
}
